...
inline std::string makeReply(const std::string& code, const std::string& target, const std::string& params)
{
...
inline std::string RPL_INVITING(const std::string& nick, const std::string& channel, const std::string& invitedNick)
{
...
inline std::string ERR_UNKNOWNMODE(const std::string& nick, char modeChar, const std::string& channel)
{
